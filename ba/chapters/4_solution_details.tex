...
After applying the transformation matrix, the resulting point is then divided by the fourth element $w$.
...
Let's assume we have a point $P$ in local space, and we want to transform it into world space.
