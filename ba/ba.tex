...
\begin{document}
\include{chaptersOther/title}
\include{chaptersOther/toc}
\include{chaptersOther/abstract}
\include{chapters/0_introduction}
\include{chapters/3_requirements_constraints}
\include{chapters/4_solution_details}
\include{chapters/6_evaluation}
\include{chapters/7_conclusion}
\include{chaptersOther/appendix}
\end{document}